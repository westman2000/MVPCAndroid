 ...
 *
 */
public abstract class MVPCView<V extends IMVPCView, P extends IMVPCPresenter<V>> extends View implements IMVPCDelegate.ICallback<V, P> {

    /**/
    private MVPCDelegate<V, P> mMvpcDelegate;


    public MVPCView(Context context) {
        super(context);
        init(context);
    }

    public MVPCView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public MVPCView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MVPCView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
