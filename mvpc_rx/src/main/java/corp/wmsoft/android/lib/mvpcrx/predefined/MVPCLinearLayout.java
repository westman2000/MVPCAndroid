 ...
 *
 */
public abstract class MVPCLinearLayout<V extends IMVPCView, P extends IMVPCPresenter<V>> extends LinearLayout implements IMVPCDelegate.ICallback<V, P> {

    /**/
    private MVPCDelegate<V, P> mMvpcDelegate;


    public MVPCLinearLayout(Context context) {
        super(context);
        init(context);
    }

    public MVPCLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public MVPCLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public MVPCLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
